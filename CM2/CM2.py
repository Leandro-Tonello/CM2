...
def generar_archivo():
    try:
        ...
        datos = pd.read_excel(ruta_archivo, usecols=[0, 1, 2, 3], header=None, engine="openpyxl", )
        ...
        df = pd.DataFrame(data, columns=['Nro', 'Nombre', 'Documento', 'Telefono', 'Tarjeta','Validado?'])
